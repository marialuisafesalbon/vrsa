...
<body>
 ...
 <a href="index.php" class="navbar-brand"><img class="logo" src="img/logo.png"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
       ...
       <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="lhr.php">Laser Hair Removal</a>
			<a class="dropdown-item active" href="faceandbody.php">Face and Body Contour</a>
	...
	<h1 class="sf">FACE AND BODY CONTOUR</h1>
	...
	<div class="row padding">
		...
		<h1 class="sf facebody">HIFU Treatment</h1>
  ...
  <div class="card wow zoomIn hifuimg">
    <img src="img/hifu.jpg" class="card-img-top" alt="...">
    <div class="card-body">
